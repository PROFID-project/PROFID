...
ggsave(
  filename = "KM_Survival_by_BMI_imp.svg",
  plot = km_plot$plot,
  width = 7,
  height = 5,
  device = "svg"
...
write.csv(as.data.frame(summary_fit), "KM_Survival_Summary_imp.csv", row.names = FALSE)
...
# Write to CSV
write.csv(logrank_results, "KM_LogRank_Test_imp.csv", row.names = FALSE)
